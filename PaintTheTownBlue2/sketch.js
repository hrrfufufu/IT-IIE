    ...
    clouds = {
        ...
        movement: function () {
            ...
            if (this.x <= this.borderLeft) {
                ...
                this.direction *= -1;
                this.y = random(30, 150); // Изменение высоты облаков
                this.speed = random(2, 4); // Изменение скорости облаков
            ...
            if (this.w <= this.borderLeft) {
                ...
                this.direction2 *= -1;
                this.s = random(180, 300); // Изменение высоты облаков
                this.speed2 = random(2, 4); // Изменение скорости облаков
